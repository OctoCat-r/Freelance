...
const Header = () => {
  return (
    <header className="relative bg-transparent h-16 flex items-center p-5 md:mt-10 mt-5 md:justify-between w-full justify-end ">
      <p className="font-poppins text-xl hidden md:block">Welcome Back!</p>
      <div className="rounded-full bg-gradient-to-t from-black to-[#27A897] p-[0.5] shadow-lg md:w-3/5 ">
